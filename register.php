                        ...
                        <form id="registration-form" action="php/process_register.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-inputs">
                                    ...
                                    <!-- Show Password Icon (hidden by default) -->
...
document.getElementById('registration-form').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        // FOR REGISTRATION: success = true means username EXISTS (BAD)
        if (checkResult.success === true) {
            ...
            // STOP HERE - DO NOT proceed to profile picture section
        ...
        // Username is AVAILABLE - proceed to profile picture section
        registrationData = {
            username: username,
            password: password
        };
        ...
        return; // Stop here on connection error
    }
});
        </script>
    </body>
