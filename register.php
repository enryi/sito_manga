    ...
    <body style="background-color: #181A1B; color: #fff; font-family: 'Noto Sans JP', 'Arial', sans-serif; min-height: 100vh;">
        ...
        <script>
            document.getElementById('registration-form').addEventListener('submit', async function (e) {
                ...
                const loadingNotificationId = showAuthNotification(
                    'info',
                    'Checking Username',
                ...
                try {
                    ...
                    if (checkResult.success === true && checkResult.message === 'Username found') {
                    ...
                    if (checkResult.success === false && checkResult.message === 'Username not found') {
                        ...
                        showAuthNotification(
                            'success',
                            'Username Available',
                            'Great! Now you can add a profile picture or skip to complete registration.'
                        );
                    ...
                    showAuthNotification(
                        'error',
                        'Database Error',
                        checkResult.message || 'Unexpected error checking username.'
                    );
