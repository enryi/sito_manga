...
<html lang="en">
    <head>
        ...
        <title>502 - Bad Gateway | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                text-shadow: 0 0 80px rgba(155, 89, 182, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    The server received an invalid response from an upstream server. This is usually a temporary issue. 
                ...
                <div class="error-suggestions">
                    ...
                    <div class="suggestions-list">
                        <div class="suggestion-item">
                            ...
                            <span>Gateway connection error</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Invalid server response</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10"></circle>
