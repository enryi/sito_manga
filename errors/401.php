...
<html lang="en">
    <head>
        ...
        <title>401 - Unauthorized | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                text-shadow: 0 0 80px rgba(232, 62, 140, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    You need to be authenticated to access this resource. Please log in with your credentials to continue.
                </p>

                <div class="error-actions">
                    <a href="<?php echo $base_url; ?>/login" class="error-btn error-btn-primary">
