...
<html lang="en">
    <head>
        ...
        <title>403 - Forbidden | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                text-shadow: 0 0 80px rgba(255, 193, 7, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    ...
                    to administrators or require special privileges.
                </p>
                ...
                <div class="error-actions">
                    ...
                    <a href="<?php echo $base_url; ?>/login" class="error-btn error-btn-secondary">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path>
                            <polyline points="10 17 15 12 10 7"></polyline>
                            <line x1="15" x2="3" y1="12" y2="12"></line>
                ...
                <div class="error-suggestions">
                    <h3 class="suggestions-title">Why is this happening?</h3>
                    <div class="suggestions-list">
                        ...
                        <div class="suggestion-item">
                            ...
                            <span>Login may be required</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Contact an admin for access</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
