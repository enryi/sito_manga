...
<html lang="en">
    <head>
        ...
        <title>404 - Page Not Found | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                font-size: 180px;
                font-weight: 900;
                background: linear-gradient(135deg, #6F2598 0%, #9b4bc7 100%);
                ...
                text-shadow: 0 0 80px rgba(111, 37, 152, 0.5);
            }
            ...
            .floating-manga {
                ...
                width: 60px;
                height: 80px;
                background: rgba(111, 37, 152, 0.2);
                border: 2px solid rgba(111, 37, 152, 0.4);
                border-radius: 4px;
            ...
            .error-btn-primary {
                background: linear-gradient(135deg, #6F2598 0%, #9b4bc7 100%);
                color: #fff;
                box-shadow: 0 4px 15px rgba(111, 37, 152, 0.4);
            }

            .error-btn-primary:hover {
                transform: translateY(-2px);
                box-shadow: 0 6px 20px rgba(111, 37, 152, 0.6);
                color: #fff;
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    The manga you're looking for seems to have vanished into another dimension. 
                    Don't worry though, we have plenty of other amazing content waiting for you!
                </p>

                <div class="error-actions">
                    <a href="<?php echo $base_url; ?>/php/redirect.php" class="error-btn error-btn-primary">
                    ...
                    <a href="<?php echo $base_url; ?>/comics" class="error-btn error-btn-secondary">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="error-suggestions">
                    ...
                    <div class="suggestions-list">
                        <div class="suggestion-item">
                            ...
                            <span>Use the search bar to find manga</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"></path>
                            </svg>
                            <span>Check out popular manga</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
