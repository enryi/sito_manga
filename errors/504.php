...
<html lang="en">
    <head>
        ...
        <title>504 - Gateway Timeout | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                line-height: 1;
                margin: 0;
                animation: timeout 3s ease-in-out infinite;
                text-shadow: 0 0 80px rgba(52, 152, 219, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    The server didn't receive a timely response from an upstream server. This is usually temporary. 
                ...
                <div class="error-suggestions">
                    <h3 class="suggestions-title">Common causes:</h3>
                    <div class="suggestions-list">
                        <div class="suggestion-item">
                            ...
                            <span>Upstream server timeout</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="suggestion-item">
                            ...
                            <span>Retry in a few seconds</span>
                        </div>
                    </div>
                </div>
            </div>
