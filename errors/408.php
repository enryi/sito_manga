...
<html lang="en">
    <head>
        ...
        <title>408 - Request Timeout | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                text-shadow: 0 0 80px rgba(108, 117, 125, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                ...
                <p class="error-message">
                    Your request took too long to complete and has timed out. This might be due to a slow connection or server load. 
                    Please try again.
                </p>
                ...
                <div class="error-suggestions">
                    <h3 class="suggestions-title">Possible solutions:</h3>
                    <div class="suggestions-list">
                        ...
                        <div class="suggestion-item">
                            ...
                            <span>Server may be under load</span>
                        </div>
                    </div>
                </div>
            </div>
