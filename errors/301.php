...
<html lang="en">
    <head>
        ...
        <title>301 - Moved Permanently | Mangas</title>
        ...
        <style>
            ...
            .error-code {
                ...
                text-shadow: 0 0 80px rgba(40, 167, 69, 0.5);
            }
        ...
        <div class="error-container">
            ...
            <div class="error-content">
                <div class="error-animation">
                    <h1 class="error-code">301</h1>
                </div>

                <h2 class="error-title">Page Moved Permanently</h2>
                <p class="error-message">
                    This page has been permanently moved to a new location. You should be redirected automatically. 
                ...
                <div class="error-suggestions">
                    <h3 class="suggestions-title">What does this mean?</h3>
                    <div class="suggestions-list">
                        <div class="suggestion-item">
                            ...
                            <span>Content moved to new URL</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Redirect is permanent</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Update your bookmarks</span>
                        </div>
                        <div class="suggestion-item">
                            <svg class="suggestion-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Auto-redirect may occur</span>
                        </div>
                    </div>
                </div>
            </div>
