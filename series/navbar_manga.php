...
?>
    ...
    <style>
        ...
        body.settings-open #settings-popup {
            z-index: 1000;
        }
        
        body.settings-open > *:not(#settings-popup) {
            pointer-events: none;
        }
    </style>
                        ...
                        <div id="profile-tab" class="settings-tab-content active">
                            <div class="settings-section">
                                ...
                                <div class="current-pfp-display">
                                    <?php if ($has_custom_pfp): ?>
                                        <img src="<?php echo htmlspecialchars($pfp_display_path); ?>" alt="Current Profile" class="current-pfp-img" />
                                    <?php else: ?>
