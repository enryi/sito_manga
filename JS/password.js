    ...
    try {
        ...
        switch (true) {
            case pwnedCount > 1000:
                ...
                strengthMessage.textContent = `Password debole`;
                console.log(`Password compromessa ${pwnedCount} volte`);
            ...
            case pwnedCount > 25:
                ...
                strengthMessage.textContent = `Password buona`;
                console.log(`Password compromessa ${pwnedCount} volte`);
            ...
            case pwnedCount === 0 && password.length > 12:
                ...
                strengthMessage.textContent = `Password sicura!`;
                console.log(`Password compromessa ${pwnedCount} volte`);
            ...
            default:
                ...
                strengthMessage.textContent = 'Password non valida';
        ...
        strengthBar.style.width = '0%';
        strengthBar.style.backgroundColor = 'transparent';
        strengthMessage.textContent = 'Errore nella verifica della password';
        strengthMessage.style.color = 'red';
        submitButton.disabled = true;
    }
}
...
function checkUsername(event) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            messageBox.innerHTML = '<div class="alert alert-danger">Username non trovato. Riprova.</div>';
            messageBox.style.display = 'block';
        }
    })
    .catch(error => {
        ...
        const messageBox = document.getElementById('message-box');
        messageBox.innerHTML = '<div class="alert alert-danger">Si è verificato un errore. Riprova più tardi.</div>';
        messageBox.style.display = 'block';
    });
}