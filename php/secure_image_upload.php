<?php
/**
 * FUNZIONE DI SICUREZZA PER UPLOAD IMMAGINI
 * Previene: code injection, shell PHP, malware, XSS, metadata EXIF malevoli
 * 
 * Salva questo file come: secure_image_upload.php nella directory /functions/
 */
...
function secureImageUpload($file, $uploadDir, $maxSize = 5242880) {
    ...
    // 3. CONTROLLO ESTENSIONE (whitelist rigorosa)
    ...
    // 4. CONTROLLO MIME TYPE REALE (non fidabile dal client)
    ...
    // 5. VERIFICA CHE SIA REALMENTE UN'IMMAGINE VALIDA
    ...
    // 6. CONTROLLO DIMENSIONI MASSIME
    $maxWidth = 5000;
    $maxHeight = 5000;
    ...
    // 7. SCANSIONE CONTENUTO PER CODICE MALEVOLO
    ...
    // 8. RICREAZIONE IMMAGINE DA ZERO (rimuove metadata EXIF e payload)
    try {
        $source = null;
        ...
        // Crea nuova immagine pulita (senza metadata)
    ...
    // 10. GENERAZIONE NOME FILE SICURO E UNIVOCO
    $timestamp = time();
    ...
    // 11. SALVATAGGIO IMMAGINE PULITA
    $save_success = false;
    ...
    // 12. IMPOSTAZIONE PERMESSI SICURI (non eseguibile)
